...
echo "       az role assignment create --assignee <principalId> --role \"Storage Table Data Contributor\" --scope \"$STORAGE_ID\""
echo "     (Data Owner is required to read the Defender scan result tags; Table Data Contributor is for the activity log)"
